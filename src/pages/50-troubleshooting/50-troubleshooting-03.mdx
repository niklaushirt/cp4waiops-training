...
See [here](/06-configure-aimanager/06-configure-aimanager-09)
...
I use the <a href="https://addons.mozilla.org/en-US/firefox/addon/elasticvue/" target="_blank" >Elasticvue</a> Firefox plugin.
