...
<a href="https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.0?topic=connections-ansible" target="_blank" >🌏 Documentation for the Task: Ansible automation provider</a>
...
🔎 The parameters can also be found in your configuration file `MY_CONFIGURATION.txt` - section  **2.3 Configure Runbooks - Ansible Automation Controller**
...
<a href="https://www.ibm.com/docs/en/cloud-paks/cloud-pak-watson-aiops/3.7.0?topic=library-create-runbook" target="_blank" >🌏 Documentation for the Task: Creating a runbook</a>
...
🔎 The parameters can also be found in your configuration file `MY_CONFIGURATION.txt` - section  `2.4 Configure Runbooks - Runbook Parameters` 
...
1. Replace `PROVIDE: my_k8s_apiurl and my_k8s_apikey` in field `Default value (optional)` with the **🗺️ Value** from the script
